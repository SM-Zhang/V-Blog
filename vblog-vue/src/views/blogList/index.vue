    ...
    <div>
        ...
        <el-form
            ...
            <el-form-item prop="title" >
                <el-input size="medium" v-model="searchMap.title" placeholder="文章"></el-input>
            </el-form-item> 
            <!-- 文章类型查询 -->
            ...
            <el-form-item prop="unickname">
                <el-input size="medium" v-model="searchMap.unickname" placeholder="昵称" ></el-input>
            </el-form-item>
            <el-form-item >
                <!-- 查询按钮 -->
                <el-button size="medium" type="primary" icon="el-icon-search" @click="fetchData()" >查询</el-button>
                <!-- 重置按钮 -->
                <el-button size="medium" @click="clearSearchMap()" >重置</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table  stripe :inline="true" :data="allArticle" height="450" empty-text="暂时还没客官想要看的呢/刷新重试?" border style="width: 100%" >
            ...
            <el-table-column :show-overflow-tooltip="true" prop="tags" label="标签" effect="light">
            ...
            <el-table-column v-if="searchMap.uroles === 3 " prop="aprivate" label="私密">
                <template slot-scope="scope">
                    <el-tag
            ...
            <el-table-column label="操作" :width="searchMap.uroles === 3 ? '210' : ''">
                <template slot-scope="scope">
                    <el-button
                        type="primary"
                        size="mini"
                        @click="handleView(scope.row.aid)">查看</el-button>
                    <el-button
                        v-if="searchMap.uroles === 3 " 
                        size="mini"
